# Musou_Sample - unity example

This example requests Playmaker and Move Motion Free Pack to run.


## document
 https://styly.cc/tips/stylymusou01/   
 https://styly.cc/tips/stylymusou02/
